            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <input
                  ...
                  v-model="skuNum"
                  @change="
                   $event.target.value >= 1?(skuNum=$event.target.value*1):(skuNum=1)
                  "
                />
...
export default {
  ...
  methods: {
    getDetailInfo(){
     ...
     async addShopCart(){
      // const result = await this.$store.dispatch('addShopCart',{skuId:this.skuId,skuNum:this.skuNum})
      // if (result === 'ok') {
      //     // 代表请求成功
      // } else {
      //   // 代表失败
