  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="(userAddress, index) in userAddressList" :key="userAddress.id"
      >
        <span
          class="username"
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(detailArray, index) in detailArrayList" :key="detailArray.skuId"
        >
          <li>
            <img
...
export default {
  ...
  async submitOrder(){
    ...
    let tradeInfo = {
      ...
      consigneeTel:this.defaultAddress.cphoneNum,
